# Ranch Expense Tracker v1.3 - Start Here

This folder contains the Version 1.3 Personal Expense Release prepared for internal Pizza Ranch use and IT evaluation.
...
- `Ranch_Expense_Tracker_v1_3_Standalone.html` - single-file review copy
